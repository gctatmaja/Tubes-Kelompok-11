...
public class Main {
   ...
   // }catch(Exception e){System.out.println("inputan harus angka+++");}
    ...
    public void menuAssisten(int i){
        int pil;
        System.out.print("Assisten ");
        Assisten a1= (Assisten) a[i];
 ...
 //      for(q=0;q<2;q++){
    ...
    public void show_Mahasiswa(){
     ...
     public void input(){
        ...
        a[0]= new Assisten("ahmad","laki-laki",19,5);
        Assisten p1=(Assisten) a[0];        
        p1.setId(1301144242);
        p1.setPass("1234");
        ...
        System.out.println();
        a[1]= new Assisten("aqli","laki-laki",19,5);
        Assisten p2=(Assisten) a[1];        
        p2.setId(1301144242);
        p2.setPass("1234");
